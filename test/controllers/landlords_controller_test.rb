...
class LandlordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post landlords_url, params: { landlord: { city: @landlord.city, first_name: @landlord.first_name, last_name: @landlord.last_name, state: @landlord.state } }
    end
  ...
  test "should update landlord" do
    patch landlord_url(@landlord), params: { landlord: { city: @landlord.city, first_name: @landlord.first_name, last_name: @landlord.last_name, state: @landlord.state } }
